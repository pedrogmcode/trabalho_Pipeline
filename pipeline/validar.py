...
def criar_schema():
    ...
    schema = DataFrameSchema({
        ...
        "cliente_id": Column(int, nullable=False, unique=True),  # Substitua None pelo código correto
        ...
        "idade": Column(int, Check.in_range(18, 90)),  # Substitua None pelo código correto
        ...
        "renda_mensal": Column(float, Check.in_range(1000, 50000)),  # Substitua None pelo código correto
        ...
        "score_credito": Column(float, Check.in_range(300, 850)),  # Substitua None pelo código correto
        ...
        "respondeu_campanha": Column(int, Check.isin([0, 1])),  # Substitua None pelo código correto
